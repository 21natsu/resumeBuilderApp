...
public class AuthService {
    ...
    private void sendVerificationEmail(User newUser) {
        ...
        try{
            ...
            String html = "<div style='font-family: Arial, sans-serif; text-align: center;'>" +
                    "<h2>Verify your email</h2>" +
                    "<p>Hi " + newUser.getName() + ", please confirm your email to activate your account.</p>" +

                    // The button link with inline styles
                    "<p><a href='" + link +

                    // Corrected Inline CSS for a clear blue button:
                    "' style='display: inline-block; " +
                    "padding: 10px 16px; " +
                    "background-color: #4f46e3; " + // Corrected: background-color with hex code
                    "color: #ffffff; " +           // Corrected: Text color (white)
                    "border-radius: 6px; " +
                    "font-weight: bold; " +        // Corrected: font-weight (500 is good, but bold is safer)
                    "text-decoration: none; " +    // Corrected: Removes underline
                    "font-size: 16px; " +          // Corrected: font-size (16px)
                    "line-height: 1.5; " +         // Helps vertical alignment
                    "border: 1px solid #4f46e3;'" + // Added a border matching the color
            ...
            log.error("Exception occurred at sendVerification(): {}",e.getMessage());
